...
public class Pokemon {
    ...
    private List<NextEv> next_ev ;
    private List<PrecEv> prec_ev ;

    public Pokemon() {
    }

    public Pokemon(int id, String num, String name, String img, List<String> type, String height, String weight, String candy, int candy_count, String egg, double spawn_chance, double avg_spawns, String spawn_time, List<Double> multipliers, List<String> weaknesses, List<NextEv> next_ev, List<PrecEv> prec_ev) {
        this.id = id;
        this.num = num;
        this.name = name;
        this.img = img;
        ...
        this.next_ev = next_ev;
        this.prec_ev = prec_ev;
    }
    ...
    public List<NextEv> getNext_ev() {
        return next_ev;
    }

    public void setNext_ev(List<NextEv> next_ev) {
        this.next_ev = next_ev;
    }

    public List<PrecEv> getPrec_ev() {
        return prec_ev;
    }

    public void setPrec_ev(List<PrecEv> prec_ev) {
        this.prec_ev = prec_ev;
    }
}
